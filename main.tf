...
module "cloudfront_cdn" {
  ...
  cf_web_acl_id                 = var.cf_web_acl_id
  cf_response_headers_policy_id = var.cf_response_headers_policy_id
...
module "account" {
  ...
  enable_account_wide_ssm_document_block_public_sharing = var.enable_account_wide_ssm_document_block_public_sharing
...
module "aws_ses" {
  ...
  create_ses_user  = var.create_ses_user
