locals {
  ...
  s3_static_website_origins = !var.enable_s3_for_static_website && var.cf_origin_access_mode != "oai"  ? {} : {
    s3_static_website = {
      ...
      s3_origin_config = {
        origin_access_identity = try(aws_cloudfront_origin_access_identity.origin_access_identity[0].cloudfront_access_identity_path, "")
      }
    }
  }
  ...
  all_origins = merge(local.alb_origins, local.s3_static_website_origins, local.s3_solution_bucket_origins, local.s3_admin_website, local.s3_static_website_origins_with_oac)
  #, local.s3_static_website_origins_with_oac, local.s3_solution_bucket_origins_with_oa
  # -------------------------------------------------------------------------------------------------------------------
