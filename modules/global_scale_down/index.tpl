...
<form id="authForm">
    ...
    <input id="token-input" type="password" placeholder="Your token value" name="token-input" required />
...
<script>
         function invoke_scale_down_lambda() {
            ...
            document.getElementById("statusMessage").innerText = "You have pressed Scale Down Button.";
         ...
         function invoke_scale_up_lambda() {
            ...
            // Show the "pressed button" message
            document.getElementById("statusMessage").innerText = "You have pressed Scale Up Button.";
